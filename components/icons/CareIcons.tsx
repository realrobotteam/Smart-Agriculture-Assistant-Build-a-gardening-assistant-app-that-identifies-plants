...
export const SoilIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M7 15V7a1 1 0 0 1 1-1h1"/>
        <path d="M10 15V4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v11"/>
        <path d="M14 15V8a1 1 0 0 1 1-1h1"/>
    </svg>
);
...
export const PruningIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <line x1="8.12" y1="15.88" x2="18" y2="21" />
    <line x1="18" y1="3" x2="8.12" y2="8.12" />
  </svg>
);
